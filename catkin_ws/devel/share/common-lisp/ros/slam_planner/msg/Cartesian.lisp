...
(cl:defmethod cl:initialize-instance :after ((m <Cartesian>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Cartesian)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name slam_planner-msg:<Cartesian> is deprecated: use slam_planner-msg:Cartesian instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Cartesian>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader slam_planner-msg:x-val is deprecated.  Use slam_planner-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Cartesian>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader slam_planner-msg:y-val is deprecated.  Use slam_planner-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Cartesian>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader slam_planner-msg:z-val is deprecated.  Use slam_planner-msg:z instead.")
  (z m))
