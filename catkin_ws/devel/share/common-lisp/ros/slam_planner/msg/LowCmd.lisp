...
(cl:defclass <LowCmd> (roslisp-msg-protocol:ros-message)
  ((levelFlag
   ...
   (motorCmd
    :reader motorCmd
    :initarg :motorCmd
    :type (cl:vector slam_planner-msg:MotorCmd)
   :initform (cl:make-array 20 :element-type 'slam_planner-msg:MotorCmd :initial-element (cl:make-instance 'slam_planner-msg:MotorCmd)))
   (led
    :reader led
    :initarg :led
...
(cl:defmethod cl:initialize-instance :after ((m <LowCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LowCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name slam_planner-msg:<LowCmd> is deprecated: use slam_planner-msg:LowCmd instead.")))
...
(cl:defmethod motorCmd-val ((m <LowCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader slam_planner-msg:motorCmd-val is deprecated.  Use slam_planner-msg:motorCmd instead.")
  (motorCmd m))
...
(cl:defmethod ff-val ((m <LowCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader slam_planner-msg:ff-val is deprecated.  Use slam_planner-msg:ff instead.")
  (ff m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LowCmd>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'motorCmd)))
    (cl:dotimes (i 20)
    (cl:setf (cl:aref vals i) (cl:make-instance 'slam_planner-msg:MotorCmd))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LowCmd>)))
  ...
  (cl:format cl:nil "uint8 levelFlag~%uint16 commVersion~%uint16 robotID~%uint32 SN~%uint8 bandWidth~%MotorCmd[20] motorCmd~%LED[4] led~%uint8[40] wirelessRemote~%uint32 reserve~%uint32 crc~%~%Cartesian[4] ff               # will delete~%================================================================================~%MSG: slam_planner/MotorCmd~%uint8 mode           # motor target mode~%float32 q            # motor target position~%float32 dq           # motor target velocity~%float32 tau          # motor target torque~%float32 Kp           # motor spring stiffness coefficient~%float32 Kd           # motor damper coefficient~%uint32[3] reserve    # motor target torque~%================================================================================~%MSG: slam_planner/LED~%uint8 r~%uint8 g~%uint8 b~%================================================================================~%MSG: slam_planner/Cartesian~%float32 x~%float32 y~%float32 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LowCmd)))
  "Returns full string definition for message of type 'LowCmd"
  (cl:format cl:nil "uint8 levelFlag~%uint16 commVersion~%uint16 robotID~%uint32 SN~%uint8 bandWidth~%MotorCmd[20] motorCmd~%LED[4] led~%uint8[40] wirelessRemote~%uint32 reserve~%uint32 crc~%~%Cartesian[4] ff               # will delete~%================================================================================~%MSG: slam_planner/MotorCmd~%uint8 mode           # motor target mode~%float32 q            # motor target position~%float32 dq           # motor target velocity~%float32 tau          # motor target torque~%float32 Kp           # motor spring stiffness coefficient~%float32 Kd           # motor damper coefficient~%uint32[3] reserve    # motor target torque~%================================================================================~%MSG: slam_planner/LED~%uint8 r~%uint8 g~%uint8 b~%================================================================================~%MSG: slam_planner/Cartesian~%float32 x~%float32 y~%float32 z~%~%"))
