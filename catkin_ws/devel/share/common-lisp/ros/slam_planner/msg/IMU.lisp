...
(cl:defmethod cl:initialize-instance :after ((m <IMU>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IMU)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name slam_planner-msg:<IMU> is deprecated: use slam_planner-msg:IMU instead.")))

(cl:ensure-generic-function 'quaternion-val :lambda-list '(m))
(cl:defmethod quaternion-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader slam_planner-msg:quaternion-val is deprecated.  Use slam_planner-msg:quaternion instead.")
  (quaternion m))

(cl:ensure-generic-function 'gyroscope-val :lambda-list '(m))
(cl:defmethod gyroscope-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader slam_planner-msg:gyroscope-val is deprecated.  Use slam_planner-msg:gyroscope instead.")
  (gyroscope m))

(cl:ensure-generic-function 'accelerometer-val :lambda-list '(m))
(cl:defmethod accelerometer-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader slam_planner-msg:accelerometer-val is deprecated.  Use slam_planner-msg:accelerometer instead.")
  (accelerometer m))

(cl:ensure-generic-function 'rpy-val :lambda-list '(m))
(cl:defmethod rpy-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader slam_planner-msg:rpy-val is deprecated.  Use slam_planner-msg:rpy instead.")
  (rpy m))
