...
(cl:defclass <TrajectoryMsg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (trajectory
    :reader trajectory
    :initarg :trajectory
    :type (cl:vector improved_local_planner-msg:TrajectoryPointMsg)
   :initform (cl:make-array 0 :element-type 'improved_local_planner-msg:TrajectoryPointMsg :initial-element (cl:make-instance 'improved_local_planner-msg:TrajectoryPointMsg))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TrajectoryMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrajectoryMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name improved_local_planner-msg:<TrajectoryMsg> is deprecated: use improved_local_planner-msg:TrajectoryMsg instead.")))
...
(cl:defmethod trajectory-val ((m <TrajectoryMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader improved_local_planner-msg:trajectory-val is deprecated.  Use improved_local_planner-msg:trajectory instead.")
  (trajectory m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrajectoryMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'trajectory)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'improved_local_planner-msg:TrajectoryPointMsg))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TrajectoryMsg>)))
  ...
  "improved_local_planner/TrajectoryMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TrajectoryMsg)))
  "Returns string type for a message object of type 'TrajectoryMsg"
  "improved_local_planner/TrajectoryMsg")
