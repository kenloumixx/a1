...
(cl:in-package improved_local_planner-msg)
...
(cl:defclass <FeedbackMsg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (trajectories
    ...
    :type (cl:vector improved_local_planner-msg:TrajectoryMsg)
   :initform (cl:make-array 0 :element-type 'improved_local_planner-msg:TrajectoryMsg :initial-element (cl:make-instance 'improved_local_planner-msg:TrajectoryMsg)))
...
(cl:defmethod cl:initialize-instance :after ((m <FeedbackMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FeedbackMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name improved_local_planner-msg:<FeedbackMsg> is deprecated: use improved_local_planner-msg:FeedbackMsg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <FeedbackMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader improved_local_planner-msg:header-val is deprecated.  Use improved_local_planner-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'trajectories-val :lambda-list '(m))
(cl:defmethod trajectories-val ((m <FeedbackMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader improved_local_planner-msg:trajectories-val is deprecated.  Use improved_local_planner-msg:trajectories instead.")
  (trajectories m))
...
(cl:defmethod selected_trajectory_idx-val ((m <FeedbackMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader improved_local_planner-msg:selected_trajectory_idx-val is deprecated.  Use improved_local_planner-msg:selected_trajectory_idx instead.")
...
(cl:defmethod obstacles_msg-val ((m <FeedbackMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader improved_local_planner-msg:obstacles_msg-val is deprecated.  Use improved_local_planner-msg:obstacles_msg instead.")
  (obstacles_msg m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <FeedbackMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'trajectories)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'improved_local_planner-msg:TrajectoryMsg))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FeedbackMsg>)))
  ...
  "improved_local_planner/FeedbackMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FeedbackMsg)))
  "Returns string type for a message object of type 'FeedbackMsg"
  "improved_local_planner/FeedbackMsg")
